...
new Swiper('.hero-animation', {
  ...
  autoplay: {
    delay: 4000,
    reverseDirection: true, // ← corrige la syntaxe, c'était une string
  ...
  on: {
    ...
    slideChangeTransitionEnd() {
      // 🎥 Gestion lecture/pause des vidéos
      document
        .querySelectorAll('.hero-animation .swiper-slide video')
        .forEach((video) => {
